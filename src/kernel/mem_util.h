...
// PROTOTYPES
// *********************************
void populate_unused_list(void);
...
BOOL combine_free_mem_nodes_if_possible( mem_node * prev_node , mem_node * new_node , mem_node * next_node , 
	mem_list * free_list , mem_list * unused_list );
